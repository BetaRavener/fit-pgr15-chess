...
{
    // Source: Aurelius
    public class ImprovedNoise : Noise
    {
        // utilities
        ...
        static int[] p = Enumerable.Repeat(0, 2 * Tabsize).ToArray();
        ...
        {
            int X = (int)Math.Floor(x) & (Tabsize - 1);                  // FIND UNIT CUBE THAT
            int Y = (int)Math.Floor(y) & (Tabsize - 1);                  // CONTAINS POINT.
